        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
            <div className="text-center mb-6">
              <div className="text-4xl font-bold text-gray-900 mb-2">$595</div>
              <div className="text-lg text-gray-600">17 Yard Dumpster</div>
          ...
          <div className="bg-white border-2 border-main rounded-lg p-8 shadow-lg relative">
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
              <div className="bg-main text-white px-4 py-1 rounded-full text-sm">Most Popular</div>
            </div>
            <div className="text-center mb-6">
              <div className="text-4xl font-bold text-gray-900 mb-2">$695</div>
              <div className="text-lg text-gray-600">21 Yard Dumpster</div>
              <div className="text-sm text-gray-500 mt-2">Includes 2 tons of waste disposal.</div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-sm">
            <div className="text-center mb-6">
              <div className="text-4xl font-bold text-gray-900 mb-2">Call Us</div>
              <div className="text-lg text-gray-600">Concrete & Dirt</div>
