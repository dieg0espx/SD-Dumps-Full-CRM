...
import { LogOut, UserIcon, Calendar, Package, Users, CreditCard, Plus, BarChart3, MessageCircle, FileText, Phone } from "lucide-react"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
const navigation = [
  ...
  { name: "Phone Bookings", href: "/admin/phone-bookings", icon: Phone },
