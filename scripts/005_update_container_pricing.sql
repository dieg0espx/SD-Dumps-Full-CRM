-- Update container types with correct SD Dumps pricing
-- Clear existing container types
DELETE FROM public.container_types;

-- Insert correct container types with SD Dumps pricing
INSERT INTO public.container_types (name, size, description, price_per_day, available_quantity) VALUES
('17 Yard Dumpster', '17 Yard', 'Perfect for medium projects - includes 2 tons of debris', 595.00, 8),
('21 Yard Dumpster', '21 Yard', 'Ideal for larger projects - includes 2 tons of debris', 695.00, 6);
